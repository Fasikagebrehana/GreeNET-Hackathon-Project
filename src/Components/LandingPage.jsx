...
import { faChartLine, faUsers, faCloudSunRain, faMapMarkedAlt } from '@fortawesome/free-solid-svg-icons';
    ...
    <div className='landingpage'>
      <div className='content'>
        ...
        <div className='headline'>
          <h1>
            Empowering Farmers and Traders with Real-Time Market <span>Insights</span>
          </h1>
          ...
          <div className='carousel'>
            ...
            <div className='carousel-testimonials'>
              {testimonials.map((testimonial, index) => (
                <div
                  key={index}
                  className={`testimonial ${index === currentIndex ? 'active' : 'inactive'}`}
                >
